...
explicitly). The coefficients rotate as the ODE state evolves: the table gives them at the
half-way step ($\approx 50\%$ \(A\) conversion) for three dissipation rates \(\varepsilon\).
At low \(\varepsilon\) (broad pdf, persistent \(A\)-rich pockets) the secondary pathways
dominate and \(S\) carries most of the product weight; at high \(\varepsilon\) (near-uniform,
\(A\)-lean) the primary reactions dominate and \(R\) and \(Q\) accumulate.
...
kink \(\fs\)           & \(0.193\)          & \(0.135\)          & \(0.078\)\\
\(\lambda\) (global)   & \(0.000^{\dagger}\)& \(0.001\)          & \(0.054\)\\\midrule
...
\[
c_{\max}(f) = \min\!\left(\frac{M_A(f)}{0.655},\;\frac{M_B(f)}{0.337},\;\frac{M_C(f)}{0.291}\right)
= \min\!\left(\frac{15f}{0.655},\;\frac{1.2(1-f)}{0.337},\;\frac{1.2(1-f)}{0.291}\right).
\]
Since \(1.2(1{-}f)/0.337 < 1.2(1{-}f)/0.291\) for all \(f\), the binding constraints are
\(A\) and \(B\). Using \(p_i=M_i(0)/|d_i|\), \(q_i=(M_i(1)-M_i(0))/|d_i|\):
\[
(p,q)_A=(0,\,22.89),\quad (p,q)_B=(3.565,\,-3.565),\quad (p,q)_C=(4.119,\,-4.119).
\]
The \(A\)- and \(B\)-lines cross at the kink: \(\fs=3.565/26.46=0.135\),
\(c^{\star}=3.083\). The peak values \(v^{\mathrm{fs}}_i=M_i(\fs)+c^{\star}d_i\) (e.g.\
\(v^{\mathrm{fs}}_R=0+3.083\times0.309=0.953\)) complete \(B_i\); their Beta-averages
give \(\avg{B_i}\), and \(C_i=B_i+(M_i-B_i)\lambda\) with \(\lambda=0.001\):
